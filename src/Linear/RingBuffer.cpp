...
RingBuffer::RingBuffer(int capacity)
    : _length(0), _capacity(capacity), _readIdx(0), _writeIdx(0),
...
RingBuffer::~RingBuffer() { delete[] _bufferArray; }

// Returns the current number of elements in the buffer
int RingBuffer::getLength() const { return _length; }

// Returns the capacity of the buffer
int RingBuffer::getCapacity() const { return _capacity; }
